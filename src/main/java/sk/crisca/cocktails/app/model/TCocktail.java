...
public class TCocktail implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2117758816503109541L;

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "t_cocktails_seq")
	@SequenceGenerator(name = "t_cocktails_seq", allocationSize = 1, sequenceName = "co.t_cocktails_cocktail_id_seq", initialValue = 0)
